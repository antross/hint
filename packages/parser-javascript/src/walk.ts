...
import { Walk, NodeVisitor } from './types';
...
const getCurrentVisitorsOrCallback = (walkArray: WalkArray, node: ESTree.Node, base?: NodeVisitor, state?: any) => {
...
type WalkArrays = { [key in keyof Walk]: WalkArray };
